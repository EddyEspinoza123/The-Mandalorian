<?php
    ...
    $actualizar_producto=$actualizar_producto->prepare("UPDATE producto SET producto_codigo=:codigo,producto_nombre=:nombre,producto_precio=:precio,producto_descripcion=:descripcion,categoria_id=:categoria WHERE producto_id=:id");
